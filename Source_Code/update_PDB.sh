...
#MIRRORDIR=/panfs/pan1.be-md.ncbi.nlm.nih.gov/interactomes/pdb/                 # your top level rsync directory
MIRRORDIR=/media/dell/DiskF/interactomes/pdb/
LOGFILE=/tmp/pdbrsync.log               # file for storing logs
...
wget ftp://ftp.ebi.ac.uk/pub/databases/msd/sifts/flatfiles/tsv/pdb_chain_uniprot.tsv.gz -O $MIRRORDIR/SIFTS/pdb_chain_uniprot.tsv.gz
#curl -o $MIRRORDIR/SIFTS/pdb_chain_uniprot.tsv.gz ftp://ftp.ebi.ac.uk/pub/databases/msd/sifts/flatfiles/tsv/pdb_chain_uniprot.tsv.gz
############################################################################
#--------------------------------------------------------------------------#
...
############################################################################
${RSYNC} -rlpt -v -z --delete --port=$PORT ${SERVER}/data/structures/divided/mmCIF/ $MIRRORDIR/mmcif > $LOGFILE 2>/dev/null
